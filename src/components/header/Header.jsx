...
const Header = () => {
  ...
  const { ecommerceData, openCart, cartQuantity } = useStateContext();
          ...
          <div className='d-flex align-items-center justify-content-between '>
            ...
            <div className='d-flex align-items-center justify-content-between'>
              <Button onClick={openCart} style={{ width: '3rem', height: '3rem', paddingInline: '10px', position: 'relative' }} variant='outline-light' className='rounded-circle'>
                ...
                <div className='rounded-circle bg-danger d-flex justify-content-center align-items-center' style={{ color: "white", position: 'absolute', width: '25px', left: 0, top: 0, transform: "translate(-25%, -5%)" }}>{cartQuantity}</div>
              </Button>
